...
public class DalerListener extends BasicChatListener {
	...
	private String getRandomMessage() {
		...
		list.add("🎶 Tunak tunak tun, tunak tunak tun, tunak tunak tun dadada! 🎶");
		list.add("Döööööööönnneeeeeeer!");
		list.add("🎶 Dalail lam wutschde dunne molita Sohle Müll im Pokal! 🎶");
